...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        if (!user) {
            const apiResponse = (0, apiResponse_1.createUnSuccessfulResponse)("Authentication required");
        ...
        if (!requiredRoles.includes(user.role)) {
            ...
            const apiResponse = (0, apiResponse_1.createUnSuccessfulResponse)(message);
